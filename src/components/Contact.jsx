  ...
  return (
    <div className='  ' id='contact' >
        <div className='w-full h-full flex flex-col text-center justify-center items-center text-[#b7ab98] font-bold  z-10 mix-blend-difference'>
              <p className='w-[] text-[2rem] tracking-[0.5rem] p-10 uppercase' onMouseEnter={()=>mouse.setSize(400)} onMouseLeave={()=>mouse.setSize(40)}>
                  my motto
              </p>
              <p className=' 2xl:text-[8rem] xl:text-[6rem] lg:text-[4rem] md:text-[2rem] sm:text-[1rem] flex p-10 uppercase ' onMouseEnter={()=>mouse.setSize(400)} onMouseLeave={()=>mouse.setSize(40)}>
                    "Writing Code, Shaping Tomorrow"
              </p>

              <p>-Developers-</p>
        </div>
        <div className='  text-[#b7ab98] font-bold mx-40 2xl:mx-80 xl:mx-72 lg:mx-64 md:mx-56 sm:mx-48 mt-40'>
